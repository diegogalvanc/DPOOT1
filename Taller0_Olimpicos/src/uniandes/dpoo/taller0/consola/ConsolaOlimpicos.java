...
public class ConsolaOlimpicos
{
	...
	private void ejecutarAtletaPais()
	{
		...
		String nombreAtleta = input("Ingrese el nombre del atleta de interés");
		String nombre = calculadora.PaisDeAtleta(nombreAtleta);
		System.out.println("El Atleta pertenece a " + nombre);
	}
